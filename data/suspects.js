...
const SUSPECTS = [
  {
    ...
    dossier: [
      ...
      "Then came the [Tariff of 1828]. It taxed imports so heavily that the South, which bought manufactured goods and sold cotton abroad, felt robbed to pay for Northern factories. Jackson supported it. Calhoun could not.",
      "Calhoun argued that South Carolina could simply refuse to obey — [nullification]. Jackson called that treason and threatened to hang him. After a furious exchange at a dinner, Calhoun did something no Vice President had ever done: he resigned.",
    ],
    grudge: "He believes Jackson would destroy the South to keep the North rich — and that Jackson threatened to hang him personally.",
  },
  {
    ...
    dossier: [
      "Clay entered Kentucky politics young and by 1811 was Speaker of the House — the most powerful man in Congress. He loves a drink, a wager, and a deal. He is the man who brings enemies together to compromise.",
  ...
  },
  {
    ...
    dossier: [
      "Ross's father was Scottish and his mother part Cherokee. Blue-eyed and fair, educated at an academy in Tennessee, he grew up Cherokee and became the leader of Cherokee resistance to white settlers taking their land. He was elected Principal Chief in 1828.",
      ...
      "Ross has met Jackson face to face at the White House twice, asking him to honor the Court and the treaties. Jackson would not move. Ross is in Washington again this winter, petitioning Congress.",
    ],
  ...
  },
  {
    ...
    dossier: [
      ...
      "Gregory did not go quietly. He has criticized the President in print for his constant use of the [veto], calling him *King Andrew*. He struggled to find work and now clerks at a shop selling hats and leather goods.",
    ],
