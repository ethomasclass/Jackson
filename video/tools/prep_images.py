...
def main():
    ...
    # --- Video 1, chapters 2-5 ---
    portrait("foot_race_1824.jpg", "foot_race", (60, 60, 2940, 2240), 81, side=2000, rough=14)
    portrait("house_morse_1822.jpg", "house_morse", (0, 0, 1920, 1261), 82, side=1800, rough=14)
    portrait("kiss_of_judas_carracci.jpg", "kiss_of_judas", (0, 0, 1686, 2344), 83, side=1400)
    portrait("john_adams_stuart.jpg", "john_adams", (0, 0, 1913, 1938), 84, side=900)
    portrait("madison_stuart.jpg", "madison", (0, 0, 1920, 2100), 85)
    portrait("hermitage_1856.jpg", "hermitage", (40, 100, 2960, 2330), 86, side=1800, rough=14)
    portrait("county_election_bingham.jpg", "county_election", (0, 0, 1920, 1382), 87, side=1800, rough=14)
    portrait("stump_speaking_bingham.jpg", "stump_speaking", (0, 0, 1920, 1411), 88, side=1800, rough=14)
    portrait("coffin_handbill_1828.jpg", "coffin_handbill", (0, 0, 1920, 2527), 89, side=1600, rough=14)
    portrait("sinking_coffins_1828.jpg", "sinking_coffins", (0, 0, 1200, 854), 90, side=1400, rough=12)
    portrait("presidents_levee_1841.jpg", "presidents_levee", (150, 110, 2160, 1270), 91, side=1800, rough=14)
    portrait("marcy_waldo.jpg", "marcy", (200, 0, 1720, 1500), 92)
    portrait("peggy_eaton_brady.jpg", "peggy_eaton", (250, 200, 1700, 1900), 93)
    portrait("john_eaton.jpg", "john_eaton", (0, 0, 871, 1000), 94, side=1000)
    portrait("floride_calhoun.jpg", "floride", (0, 0, 200, 296), 95, side=300, rough=8)
    portrait("calhoun_healy.jpg", "calhoun", (0, 0, 1920, 2200), 96)
    portrait("van_buren_inman.jpg", "van_buren", (100, 0, 1820, 2000), 97)
    portrait("little_magician_1840.jpg", "little_magician", (0, 0, 1536, 1203), 98, side=1400, rough=12)
    portrait("rats_leaving_1831.jpg", "rats_leaving", (0, 0, 2224, 3000), 99, side=1500, rough=12)
    portrait("jackson_parton_1860_plate.jpg", "jackson_plate", (200, 700, 1750, 3000), 100, side=1400, rough=12)
    rb = Image.open(os.path.join(IMG, "rachel_earl.jpg")).crop((150, 0, 1770, 1500))
    scrap(ImageOps.grayscale(rb).convert("RGB"), "rachel_mourning", seed=101, max_side=1200)
    portrait("punch_bowl_met.jpg", "punch_bowl", (80, 260, 2380, 1760), 102, side=1200, rough=14)
